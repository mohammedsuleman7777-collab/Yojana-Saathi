...
import { getScheme, updateScheme } from "@/lib/schemes";
import {
  Save,
  ArrowLeft,
  AlertCircle,
...
export default function EditSchemePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setError("Unable to update scheme. Please verify inputs.");
    } finally {
      setSaving(false);
    }
  }
  ...
  return (
    <AuthGuard allowedRoles={["admin"]}>
      <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8 space-y-6">
        <AdminHeader
          title={`Edit: ${formData.name || "Government Scheme"}`}
          subtitle={`Scheme ID: ${schemeId}`}
        />
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm space-y-5">
            <div className="flex items-center gap-2 pb-3 border-b border-slate-100">
              ...
              <h2 className="text-base font-bold text-slate-900">Benefits & Documents</h2>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                required
                className="block w-full rounded-xl border border-slate-200 px-3.5 py-2.5 text-sm text-slate-900 font-mono focus:border-emerald-600 focus:outline-none focus:ring-2 focus:ring-emerald-500/20"
              />
            </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm space-y-5">
            <div className="flex items-center gap-2 pb-3 border-b border-slate-100">
              ...
              <h2 className="text-base font-bold text-slate-900">Application Procedure</h2>
            </div>
